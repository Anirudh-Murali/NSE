...
data_file = input("Enter name of data file")
with open('Data/'+str(data_file), 'r') as csvfile:
...
df1 = df
idx = pd.date_range('01-03-2017', '12-31-2017')
...
interpolated_df.to_pickle('Data/new_pickled'+str(data_file)+'.pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('Data/new'+str(data_file)+'.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('Data/new_new_'+str(data_file)+'.pkl')
